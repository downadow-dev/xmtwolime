...
for arg in sys.argv[3:]:
    ...
    print('\t\t\t\t\tmov UR24, ' + str(ord(filename[0])))
    print('\t\t\t\t\tif UR25 != UR24, UR17')
    
    print('\t\t\t\t\tmov UR24, ' + str(ord(filename[1])))
    print('\t\t\t\t\tif UR26 != UR24, UR17')
    
    print('\t\t\t\t\tmov UR24, ' + str(ord(filename[2])))
    print('\t\t\t\t\tif UR27 != UR24, UR17')
